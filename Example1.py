...
detected_circles = cv2.HoughCircles(gray_blurred,  
               ...
               param2 = 30, minRadius = 200, maxRadius = 220)
...
if detected_circles is not None: 
    ...
    # finds the largest circle and sets that as origin
...
cv2.putText(filtered_base, "Filtered Base", (200, 500),cv2.FONT_HERSHEY_SIMPLEX, 1.5, (255, 255, 255), 2)
plt.imshow(filtered_base),plt.show()
cv2.putText(filtered_rot, "Filtered Rotated", (200, 500),cv2.FONT_HERSHEY_SIMPLEX, 1.5, (255, 255, 255), 2)
...
if M["m00"] != 0:
 ...
 cX, cY = 0, 0
cv2.circle(img_base, (cX, cY), 5, (255, 255, 255), 5)
cv2.putText(img_base, "centroid", (cX - 25, cY - 25),cv2.FONT_HERSHEY_SIMPLEX, 1.5, (0, 0, 0), 2)
...
if M["m00"] != 0:
 ...
 cX, cY = 0, 0
cv2.circle(img_rotated, (cX, cY), 5, (255, 255, 255), 5)
cv2.putText(img_rotated, "centroid", (cX - 100, cY - 25),cv2.FONT_HERSHEY_SIMPLEX, 1.5, (0, 0, 0), 2)
# convert from BGR to RGB so we can plot using matplotlib
...
cv2.putText(img, degree, (a, b + 100),cv2.FONT_HERSHEY_SIMPLEX, 1.5, (0, 0, 0), 2)
