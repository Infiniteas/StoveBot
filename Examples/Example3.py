# -*- coding: utf-8 -*-
"""
Created on Mon Dec  7 15:11:51 2020
...
cv2.putText(filtered_rot_blue, "Filtered Blue", (600, 800),cv2.FONT_HERSHEY_SIMPLEX, 4.5, (255, 255, 255), 5)
...
for c in contours_rot:
    ...
    if cX < 1000:
        img_rot = cv2.arrowedLine(img_rot, (xl, yl), (cX, cY), (0, 0, 255), 5)
        img_rot = cv2.arrowedLine(img_rot, (xl, yl), (xl, yl-rl), (0, 0, 255), 5)
        tl = np.array([(cX - xl), -1*(cY - yl), 0])
        print("tl ", tl)
    else:
        img_rot = cv2.arrowedLine(img_rot, (xr, yr), (cX, cY), (0, 0, 255), 5)
        img_rot = cv2.arrowedLine(img_rot, (xr, yr), (xr, yr-rr), (0, 0, 255), 5)
...
cv2.putText(img_rot, degree_left, (xl, yl + 100),cv2.FONT_HERSHEY_SIMPLEX, 2.5, (58, 125, 134), 4)
cv2.putText(img_rot, degree_right, (xr, yr + 100),cv2.FONT_HERSHEY_SIMPLEX, 2.5, (58, 125, 134), 4)
